...
function Calculator() {
    ...
    //Clear list of score counts and set all states to initial state.
    function Clear() {
        setList(initialList);
        ProcessCount(initialList);
    }

    //Validate input boxes to make sure only positive whole numbers are accepted
    function Validate(e) {
        if (!/[0-9]/.test(e.key)) {
            e.preventDefault();
        }
    ...
    function HandleReset() {
        Clear();
        clearFields();  //js function imported from utils.js, to reset input fields in DOM
    }
    ...
    function ProcessCount(list) {
        ...
        if (totalCount > 0) {      //avoid dividing by 0
                            ...
                            <div className="promotor_input">
                                ...
                                <div className="input_group">
                                    <div className="input_container">
                                        ...
                                        <div>
                                            <input className="input_field" type="number" onKeyPress={(e) => Validate(e)} onChange={(e) => HandleInput(10, e.target.value)}></input>
                                        </div>
                                    </div>
                                    <div className="input_container">
                                        <div className="input_number green">9</div>
                                        <div>
                                            <input className="input_field" type="number" onKeyPress={(e) => Validate(e)} onChange={(e) => HandleInput(9, e.target.value)}></input>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="neutral_input">
                                ...
                                <div className="input_group">
                                    <div className="input_container">
                                        ...
                                        <div>
                                            <input className="input_field" type="number" onKeyPress={(e) => Validate(e)} onChange={(e) => HandleInput(8, e.target.value)}></input>
                                        </div>
                                    </div>
                                    <div className="input_container">
                                        <div className="input_number grey">7</div>
                                        <div>
                                            <input className="input_field" type="number" onKeyPress={(e) => Validate(e)} onChange={(e) => HandleInput(7, e.target.value)}></input>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="detractor_input">
                                ...
                                <div className="input_group">
                                    <div className="input_container">
                                        ...
                                        <div>
                                            <input className="input_field" type="number" onKeyPress={(e) => Validate(e)} onChange={(e) => HandleInput(6, e.target.value)}></input>
                                        </div>
                                    </div>
                                    <div className="input_container">
                                        <div className="input_number red">5</div>
                                        <div>
                                            <input className="input_field" type="number" onKeyPress={(e) => Validate(e)} onChange={(e) => HandleInput(5, e.target.value)}></input>
                                        </div>
                                    </div>
                                    <div className="input_container">
                                        <div className="input_number red">4</div>
                                        <div>
                                            <input className="input_field" type="number" onKeyPress={(e) => Validate(e)} onChange={(e) => HandleInput(4, e.target.value)}></input>
                                        </div>
                                    </div>
                                    <div className="input_container">
                                        <div className="input_number red">3</div>
                                        <div>
                                            <input className="input_field" type="number" onKeyPress={(e) => Validate(e)} onChange={(e) => HandleInput(3, e.target.value)}></input>
                                        </div>
                                    </div>
                                    <div className="input_container">
                                        <div className="input_number red">2</div>
                                        <div>
                                            <input className="input_field" type="number" onKeyPress={(e) => Validate(e)} onChange={(e) => HandleInput(2, e.target.value)}></input>
                                        </div>
                                    </div>
                                    <div className="input_container">
                                        <div className="input_number red">1</div>
                                        <div>
                                            <input className="input_field" type="number" onKeyPress={(e) => Validate(e)} onChange={(e) => HandleInput(1, e.target.value)}></input>
                                        </div>
                                    </div>
                                    <div className="input_container">
                                        <div className="input_number red">0</div>
                                        <div>
                                            <input className="input_field" type="number" onKeyPress={(e) => Validate(e)} onChange={(e) => HandleInput(0, e.target.value)}></input>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="promotor_total">
                                ...
                                <div className="input_group">
                                    <div className="input_container">
                                        ...
                                        <div>
                                            <input className="input_field" value={promotor} readOnly></input>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="neutral_total">
                                ...
                                <div className="input_group">
                                    <div className="input_container">
                                        ...
                                        <div>
                                            <input className="input_field" value={neutral} readOnly></input>
                                        </div>
                                    </div>
                                </div>
                                <div className="line"></div>
                            ...
                            <div className="detractor_total">
                                ...
                                <div className="input_group">
                                    <div className="input_container">
                                        ...
                                        <div>
                                            <input className="input_field" value={detractor} readOnly></input>
                                        </div>
                                    </div>
                                </div>
